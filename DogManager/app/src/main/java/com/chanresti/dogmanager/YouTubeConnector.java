...
public class YouTubeConnector {
    ...
    public static final String API_KEY = "AIzaSyBnlrE0dUqsRRSVuXuwm-na8Wzqz7HHSRE";
    ...
    public List<VideoItem> search() {
        ...
        try {
            ...
            Log.d("YTCSearch", "Exception: "+e.getMessage());
            return null;
        }
    }
    ...
    private static List<VideoItem> setVideoList(Iterator<SearchResult> iteratorSearchResults) {
        ...
        Log.d("YTCsetVL", "Videolist size: "+videoList.size());
